...
//     try {
//       await axios.post(`${API_URL}/api/send-certificate`, {
//         score: score,
...
//         description: 'Your certificate has been sent to your registered email.',
//         status: 'success',
//         duration: 5000,
//         isClosable: true,
//       });
...
//       toast({
//         title: 'Error',
//         description: 'Failed to send certificate. Please try again later.',
//         status: 'error',
//         duration: 5000,
//         isClosable: true,
//       });
...
//     const passPercentage = (score / quizData.length) * 100;
